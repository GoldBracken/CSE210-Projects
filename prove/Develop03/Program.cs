/*
Exceeds Requirements: A new menu has been added that let's the user select a scripture 
to practice and once they have finished practicing a scripture they are given the chance 
to continue practicing by selecting a scripture again.
*/
...
class Program
{
    ...
    static void practiceScripture()
    {
        ...
        Scripture john = new Scripture(scriptureReference, "For God so loved the world, that he gave his only begotten Son, that whosoever believeth in him should not perish, but have everlasting life.");
        Scripture moroni = new Scripture(new Reference("Moroni", 10, new List<int>() { 3, 5 }), "Behold, I would exhort you that when ye shall read these things, if it be wisdom in God that ye should read them, that ye would remember how merciful the Lord hath been unto the children of men, from the creation of Adam even down until the time that ye shall receive these things, and ponder it in your hearts. And when ye shall receive these things, I would exhort you that ye would ask God, the Eternal Father, in the name of Christ, if these things are not true; and if ye shall ask with a sincere heart, with real intent, having faith in Christ, he will manifest the truth of it unto you, by the power of the Holy Ghost. And by the power of the Holy Ghost ye may know the truth of all things.");
